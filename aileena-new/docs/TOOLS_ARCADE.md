...
| `computer` | `/tools/computer` | **Experiment** — owner computer in the site-agent dialog; local shim; no merge. Real Cloudflare Computer: [`CLOUDFLARE_COMPUTER.md`](./CLOUDFLARE_COMPUTER.md) (spec only) |
