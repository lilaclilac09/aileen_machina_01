...
8. Proof queue: visitors may "log issue: …" (observed only). Owner cookie: "propose fix for /route: …", "show proof queue", "approve/reject/mark ready/prepare PR for proposal <id>". Never merge. Never treat a visitor note as approved. Owner panel is /proof.
