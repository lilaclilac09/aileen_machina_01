...
export const TOOL_DEFINITIONS: ToolDefinition[] = [
  {
    ...
    tag: 'EVENT',
    title: 'Cafe Cursor',
    body: 'Credits for checked-in guests.',
    why: 'Redeem path for the room.',
    verdict: 'Useful when the room is real.',
  ...
  },
  {
    ...
    body: 'YouTube → clips. Free mode.',
    why: 'Cut without a listening API.',
  ...
  },
  {
    ...
    body: 'Local JSON → ffmpeg.',
    why: 'A recap loop, not a product.',
    verdict: 'Not better than CapCut yet.',
