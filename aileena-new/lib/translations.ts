    ...
    tools: {
      ...
      items: {
        'inkling-clips': {
          ...
          body:
            'YouTube in → Inkling picks moments → ffmpeg cuts clips. Long-form audio, short cuts.',
        },
        'feed-flash': {
          tag: 'RSS',
          title: 'Feed Flash',
      ...
      inklingClips: {
        ...
        body:
          'Paste a YouTube URL. Inkling listens to the episode and proposes cuts; ffmpeg renders the clips.',
        backToTools: '← Tools',
        ...
        scoreLabel: 'score',
        disclaimer:
          '8 runs per visitor per day. Long episodes take a few minutes. Results expire in 24h.',
    ...
    tools: {
      ...
      items: {
        'inkling-clips': {
          ...
          title: 'Audio Clipping',
          body:
            'YouTube rein → Inkling findet Momente → ffmpeg schneidet Clips. Long-form rein, kurze Cuts raus.',
        },
        'feed-flash': {
          tag: 'RSS',
          title: 'Feed Flash',
      ...
      inklingClips: {
        ...
        heading: 'Audio Clipping',
        body:
          'YouTube-URL einfügen. Inkling hört die Episode und schlägt Schnitte vor; ffmpeg rendert die Clips.',
        backToTools: '← Tools',
        youtubeLabel: 'YouTube-URL',
        modeBest: 'Highlights',
        ...
        scoreLabel: 'score',
        disclaimer:
          '8 Runs pro Besucher und Tag. Lange Episoden dauern ein paar Minuten. Ergebnisse verfallen nach 24h.',
