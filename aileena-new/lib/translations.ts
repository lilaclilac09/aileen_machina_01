...
export const t = {
  EN: {
    ...
    tools: {
      tag: 'ARCADE',
      heading: 'Insert coin to play',
      body: 'Browser mini-games — free to play, rate-limited. Same stack as the site, dressed like an arcade cabinet.',
      marquee:
        'FREE PLAY · INKLING CLIP QUEST · YOUTUBE IN · CLIPS OUT · 8 RUNS PER DAY · PRESS START',
      pressStart: 'Press start',
      creditsLabel: 'CREDITS',
      creditsHint: 'unlimited imagination',
      gameCount: 'cabinet(s)',
      comingSoonTitle: 'Cabinet empty',
      comingSoonBody: 'Next mini-game loading…',
      openTool: 'Play',
      items: {
        'inkling-clips': {
          tag: 'AUDIO · AI',
      ...
      inklingClips: {
        ...
        heading: 'Clip Quest',
        body:
          'A podcast-mining mini-game. Inkling hears the full tape; you get the best cuts — or hunt a topic.',
        backToTools: '← Arcade',
        youtubeLabel: 'Insert tape (YouTube URL)',
        modeBest: 'Highlights',
        modeQuery: 'Topic hunt',
        queryLabel: 'What to find',
        queryPlaceholder: 'e.g. mixture of experts, pricing strategy…',
        countLabel: 'Clips to win (max 8)',
        submit: 'Press start',
        running: 'Playing…',
        listening: 'Inkling is listening',
        levelLabels: {
          download: 'STAGE 1 · FETCH',
          convert: 'STAGE 2 · RIP WAV',
          batch: 'STAGE 3 · SPLIT',
          propose: 'STAGE 4 · LISTEN',
          correct: 'STAGE 5 · TRIM',
          render: 'STAGE 6 · CUT',
          done: 'GAME CLEAR',
          error: 'GAME OVER',
        },
        highScore: 'Highlights unlocked',
        scoreLabel: 'score',
        disclaimer:
          'Free play — 8 runs per visitor per day. Long episodes take a few minutes. Saves expire in 24h.',
        resultsHint: 'Jump to the moment or grab the cut.',
        openYoutube: 'Jump in',
        downloadClip: 'Take clip',
        errors: {
  ...
  DE: {
    ...
    tools: {
      tag: 'ARCADE',
      heading: 'Münze einwerfen',
      body: 'Browser-Minispiele — gratis spielbar, rate-limited. Gleicher Stack wie die Site, verkleidet als Arcade.',
      marquee:
        'GRATIS · INKLING CLIP QUEST · YOUTUBE REIN · CLIPS RAUS · 8 RUNS PRO TAG · START DRÜCKEN',
      pressStart: 'Start',
      creditsLabel: 'CREDITS',
      creditsHint: 'unbegrenzte Fantasie',
      gameCount: 'Automat(en)',
      comingSoonTitle: 'Automat leer',
      comingSoonBody: 'Nächstes Minispiel lädt…',
      openTool: 'Spielen',
      items: {
        'inkling-clips': {
          tag: 'AUDIO · KI',
      ...
      inklingClips: {
        ...
        heading: 'Clip Quest',
        body:
          'Podcast-Mining als Minispiel. Inkling hört das volle Tape — du bekommst die besten Schnitte oder jagst ein Thema.',
        backToTools: '← Arcade',
        youtubeLabel: 'Tape einlegen (YouTube-URL)',
        modeBest: 'Highlights',
        modeQuery: 'Themenjagd',
        queryLabel: 'Was suchen',
        queryPlaceholder: 'z.B. mixture of experts, Preisstrategie…',
        countLabel: 'Clips gewinnen (max. 8)',
        submit: 'Start drücken',
        running: 'Läuft…',
        listening: 'Inkling hört zu',
        levelLabels: {
          download: 'STUFE 1 · LADEN',
          convert: 'STUFE 2 · WAV',
          batch: 'STUFE 3 · SPLIT',
          propose: 'STUFE 4 · HÖREN',
          correct: 'STUFE 5 · TRIM',
          render: 'STUFE 6 · SCHNITT',
          done: 'GESCHAFFT',
          error: 'GAME OVER',
        },
        highScore: 'Highlights freigeschaltet',
        scoreLabel: 'score',
        disclaimer:
          'Gratis — 8 Runs pro Besucher und Tag. Lange Episoden dauern ein paar Minuten. Saves verfallen nach 24h.',
        resultsHint: 'Zum Moment springen oder Cut mitnehmen.',
        openYoutube: 'Springen',
        downloadClip: 'Clip nehmen',
        errors: {
