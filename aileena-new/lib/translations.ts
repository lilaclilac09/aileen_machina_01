...
export const t = {
  EN: {
    ...
    visual: {
      ...
      kilnNote: 'The glass I fired belongs here too — colour, powder, heat, patience. A small visual drawer: keep each print’s own shape.',
      readGlass: 'On the glass — how powder becomes density →',
      modeWall: 'wall',
      modeFocus: 'focus',
      items: [
        { src: '/pate-clay.jpg', alt: 'Rolling out the clay', caption: 'rolling the clay', href: '/blog/pate-de-verre', width: 1100, height: 1100 },
        { src: '/bg_pic/03.jpeg', alt: 'A tall scrap from the desk drawer', caption: 'tall scrap', width: 1792, height: 2400 },
        { src: '/pate-shapes.jpg', alt: 'Clay shapes drying on plaster bats', caption: 'cutting shapes', href: '/blog/pate-de-verre', width: 1100, height: 1100 },
        { src: '/bg_pic/02.jpeg', alt: 'A wide frame from the years before code', caption: 'wide frame', width: 2752, height: 1536 },
        { src: '/pate-mould.jpg', alt: 'Two-part plaster moulds drying on the bench', caption: 'the plaster mould', href: '/blog/pate-de-verre', width: 1100, height: 1100 },
        { src: '/zine/clipping-desk.jpg', alt: 'Clipping desk fragment', caption: 'clipping desk', width: 640, height: 960 },
        { src: '/pate-glass.jpg', alt: 'Coloured glass frit packed into the moulds', caption: 'glass, by colour', href: '/blog/pate-de-verre', width: 1100, height: 1100 },
        { src: '/agent-portrait.jpeg', alt: 'A quiet portrait kept in the archive', caption: 'kept portrait', width: 736, height: 914 },
        { src: '/bg_pic/04.jpeg', alt: 'Another wide scrap from the shelf', caption: 'shelf light', width: 2752, height: 1536 },
      ],
    },
    writingWall: {
  ...
  DE: {
    ...
    tools: {
      ...
      items: {
        'inkling-clips': {
          tag: 'AUDIO',
          title: 'Audio Clipping',
          body: 'YouTube → kurze Clips. Kein Inkling-API, Free-Mode-Umweg.',
          why: 'Ein Schnitt, ohne eine Listening-API zu bezahlen.',
        ...
        'cafe-cursor': {
          tag: 'EVENT',
          title: 'Cafe Cursor',
          body: 'Cursor Credits für Cafe Cursor Shanghai einlösen — nur checked-in Gäste.',
          why: 'Der Raum brauchte einen Redeem-Weg, der kein Spreadsheet war.',
          verdict: 'Wirklich nützlich, wenn der Raum echt ist.',
          statusLabel: 'useful',
        },
        'cafe-recap': {
          tag: 'VIDEO',
          title: 'Cafe Recap Edit',
          body: 'Lokaler JSON → ffmpeg Recap-Loop. Planen, schneiden, prüfen.',
          why: 'Ein Beleg vom Versuch, eine IRL-Nacht zu schneiden, ohne zuerst CapCut zu öffnen.',
    ...
    visual: {
      ...
      kilnNote: 'Das Glas, das ich gebrannt habe, gehört hier auch hin — Farbe, Pulver, Hitze, Geduld. Eine kleine visuelle Schublade: jedes Bild behält seine Form.',
      readGlass: 'Über das Glas — wie Pulver zu Dichte wird →',
      modeWall: 'wand',
      modeFocus: 'fokus',
      items: [
        { src: '/pate-clay.jpg', alt: 'Ton ausrollen', caption: 'Ton ausrollen', href: '/blog/pate-de-verre', width: 1100, height: 1100 },
        { src: '/bg_pic/03.jpeg', alt: 'Ein hohes Fragment aus der Schreibtischschublade', caption: 'hohes Fragment', width: 1792, height: 2400 },
        { src: '/pate-shapes.jpg', alt: 'Tonformen auf Gipsplatten', caption: 'Formen schneiden', href: '/blog/pate-de-verre', width: 1100, height: 1100 },
        { src: '/bg_pic/02.jpeg', alt: 'Ein breiter Rahmen aus den Jahren vor dem Code', caption: 'breiter Rahmen', width: 2752, height: 1536 },
        { src: '/pate-mould.jpg', alt: 'Zweiteilige Gipsformen auf der Werkbank', caption: 'die Gipsform', href: '/blog/pate-de-verre', width: 1100, height: 1100 },
        { src: '/zine/clipping-desk.jpg', alt: 'Fragment vom Clipping-Schreibtisch', caption: 'Clipping-Tisch', width: 640, height: 960 },
        { src: '/pate-glass.jpg', alt: 'Farbiges Glasgranulat in den Formen', caption: 'Glas, nach Farbe', href: '/blog/pate-de-verre', width: 1100, height: 1100 },
        { src: '/agent-portrait.jpeg', alt: 'Ein ruhiges Porträt im Archiv', caption: 'aufgehobenes Porträt', width: 736, height: 914 },
        { src: '/bg_pic/04.jpeg', alt: 'Noch ein breites Fragment vom Regal', caption: 'Regallicht', width: 2752, height: 1536 },
      ],
    },
    writingWall: {
