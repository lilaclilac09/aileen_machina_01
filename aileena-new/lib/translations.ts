  ...
  EN: {
    ...
    tools: {
      ...
      computer: {
        ...
        backToTools: '← Tools',
        marquee: 'COMPUTER · SAME DIALOG · PASSKEY · NO MERGE',
        sameDialog: 'same dialog · not a window',
        howto:
          'Unlock with this device. The dock sits under the transcript. Heavy work says queued and she still talks.',
  ...
  DE: {
    ...
    tools: {
      ...
      computer: {
        ...
        backToTools: '← Tools',
        marquee: 'COMPUTER · SELBER DIALOG · PASSKEY · KEIN MERGE',
        sameDialog: 'selber Dialog · kein Fenster',
        howto:
          'Mit diesem Gerät entsperren. Das Dock sitzt unter dem Transkript. Schwere Arbeit sagt queued — und sie redet weiter.',
