      ...
      womanInTech: {
        ...
        posts: [
          ...
          },
          {
            ...
            body: 'The best tech salespeople don\'t sell — they listen, translate, and make the buyer feel right. Pressure is what happens when one side is trying to compensate for an exchange the other side doesn\'t believe in. You don\'t have to change your character; you change your sales (it\'s a skill, not a personality). Read which buyer is across the line — logical (lead with the spreadsheet) vs emotional (lead with the story); most are 70/30, not 100/0. Thick skin doesn\'t mean stop feeling rejection — it means don\'t let a no become an identity claim and don\'t carry the last call\'s residue into the next one (the call after a hard no is the one that pays). Most "objections" aren\'t objections — they\'re requests for information delivered in a defensive frame. And now there\'s a third buyer on the line: AI agents — the pure logical buyer the textbooks always implied, where your spec is your homepage, your eval is your demo, and your error codes are your objection-handling.',
          },
        ],
      },
    },
      ...
      womanInTech: {
        ...
        posts: [
          ...
          },
          {
            ...
            body: 'Die besten Tech-Verkäufer verkaufen nicht — sie hören zu, übersetzen und sorgen dafür, dass sich der Käufer richtig fühlt. Druck entsteht dort, wo eine Seite einen Tausch ausgleichen will, an den die andere nicht glaubt. Du musst nicht deinen Charakter ändern, sondern deinen Vertrieb (Verkaufen ist eine Fertigkeit, keine Persönlichkeit). Lies, wer auf der anderen Seite sitzt — logisch (führe mit der Tabelle) oder emotional (führe mit der Geschichte); die meisten sind 70/30, nicht 100/0. Dickhäutig sein heißt nicht, Ablehnung nicht mehr zu spüren — es heißt, ein Nein nicht zum Identitätsanspruch werden zu lassen und den Rückstand des letzten Anrufs nicht in den nächsten zu tragen (der Anruf nach einem harten Nein ist der, der bezahlt). Die meisten „Einwände" sind keine Einwände — es sind Informationsanfragen in einer Verteidigungshaltung. Und jetzt sitzt ein dritter Käufer am Tisch: KI-Agenten — der reine logische Käufer, den die Lehrbücher immer meinten. Deine Spec ist deine Startseite, dein Eval ist dein Demo, deine Fehlercodes sind dein Einwandbehandlung.',
          },
        ],
      },
    },
