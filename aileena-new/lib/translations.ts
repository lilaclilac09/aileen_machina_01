  ...
  EN: {
    ...
    tools: {
      ...
      aiFactorySim: {
        ...
        rearView: 'rear face',
        inspectHint: 'drag the hall, click a rack, then a live cell. Open tray pulls one tray so GPU / CPU / HBM / DPU / OSFP get a source-backed intro and a live kW share.',
        ...
        photorealNote: 'PBR camera on sourced inventory. Procedural mesh — not a vendor scan, not Omniverse.',
        powerPaths: {
          'legacy-ac': 'legacy AC',
  ...
  DE: {
    ...
    tools: {
      ...
      aiFactorySim: {
        ...
        frontView: 'Front',
        rearView: 'Rückseite',
        inspectHint: 'Halle ziehen, Rack, dann eine Live-Zelle. Open tray zieht ein Tray — GPU / CPU / HBM / DPU / OSFP mit Quellen-Intro und live-kW-Anteil.',
        liveLabel: 'Live Plant',
        ...
        chipLabel: 'Chip-Intro',
        photorealNote: 'PBR-Kamera auf sourced Inventory. Prozedurales Mesh — kein Vendor-Scan, kein Omniverse.',
        powerPaths: {
          'legacy-ac': 'legacy AC',
          '800v-sidecar': '800V Sidecar',
          'facility-hvdc': 'Facility HVDC',
