...
export const t = {
  EN: {
    ...
    tools: {
      tag: 'TOOLS LAB',
      heading: 'tools lab',
      body: 'Some useful. Some still losing to normal apps.',
  ...
  DE: {
    ...
    tools: {
      tag: 'TOOLS LAB',
      heading: 'tools lab',
      body: 'Manche nützlich. Manche verlieren noch gegen normale Apps.',
      ...
      items: {
        'inkling-clips': {
          ...
          title: 'Audio Clipping',
          body: 'YouTube → Clips. Free Mode.',
          why: 'Schnitt ohne Listening-API.',
        ...
        'cafe-cursor': {
          tag: 'EVENT',
          title: 'Cafe Cursor',
          body: 'Credits für checked-in Gäste.',
          why: 'Redeem-Weg für den Raum.',
          verdict: 'Nützlich, wenn der Raum echt ist.',
          statusLabel: 'useful',
        },
        'cafe-recap': {
          tag: 'VIDEO',
          title: 'Cafe Recap Edit',
          body: 'Lokales JSON → ffmpeg.',
          why: 'Ein Recap-Loop, kein Produkt.',
          verdict: 'Noch nicht besser als CapCut.',
          statusLabel: 'experiment',
        },
        'feed-flash': {
          tag: 'RSS',
