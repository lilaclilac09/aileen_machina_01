  ...
  EN: {
    ...
    tools: {
      ...
      aiFactorySim: {
        ...
        rearView: 'rear face',
        inspectHint: 'Satellite → campus → hall → cabinet → rack → open tray. Same plant kernel at every scale. Globe/aerial are stylized, not live tiles.',
        ...
        scaleLabel: 'scale',
        photorealNote: 'Branch-Education scale ladder on the same kernel. Stylized globe/aerial — not live satellite tiles, not a vendor scan, not Omniverse.',
        powerPaths: {
          'legacy-ac': 'legacy AC',
  ...
  DE: {
    ...
    tools: {
      ...
      aiFactorySim: {
        ...
        frontView: 'Front',
        rearView: 'Rückseite',
        inspectHint: 'Satellit → Campus → Halle → Schrank → Rack → offenes Tray. Derselbe Pflanzenkern auf jeder Skala. Globus/Aerial sind stilisiert, keine Live-Kacheln.',
        liveLabel: 'Live Plant',
        ...
        chipLabel: 'Chip-Intro',
        scaleLabel: 'Skala',
        photorealNote: 'Branch-Education-Skala auf demselben Kern. Stilisierter Globus/Aerial — keine Live-Satellitenkacheln, kein Vendor-Scan, kein Omniverse.',
        powerPaths: {
          'legacy-ac': 'legacy AC',
          '800v-sidecar': '800V Sidecar',
          'facility-hvdc': 'Facility HVDC',
