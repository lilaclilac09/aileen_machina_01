      ...
      <section style={{ padding: '80px 32px 64px', maxWidth: 900, margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 24, marginBottom: 40, flexWrap: 'wrap' }}>
          ...
          <span style={{
            ...
            Solana · Prop AMM · Reverse Engineering
          </span>
        </div>
        ...
        <h1 style={{
          ...
          The Pool<br /><span style={{ color: '#00ffea' }}>That Wasn&apos;t a Pool</span>
        </h1>
        ...
        <p style={{
          ...
          Ten closed-source proprietary AMMs are doing most of the quiet flow on Solana mainnet.
          Eight of them have their byte-level pool layouts in <a href="https://gist.github.com/mubarizkyc/959ac9b33dae4f3a86c6e00c331a9901" target="_blank" rel="noopener noreferrer" style={inlineLink}>a single public gist</a>.
          The other two — humidifi and aquifier — were blank. I tried to finish the table.
          Aquifier took 90 seconds and no API key. Humidifi turned out to be hiding a different kind of answer.
        </p>
      </section>
