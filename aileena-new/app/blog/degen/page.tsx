  ...
  return (
    <div style={{
      ...
      <header style={{
        ...
        <span style={{ fontFamily: mono, fontSize: '0.55rem', letterSpacing: '0.4em', color: 'rgba(255,255,255,0.2)', textTransform: 'uppercase' }}>
          AILEENA MACHINA
        </span>
      </header>
      ...
      <section style={{ padding: '80px 32px 64px', maxWidth: 900, margin: '0 auto' }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 24, marginBottom: 40, flexWrap: 'wrap' }}>
          <span style={{
            fontFamily: mono, fontSize: '0.55rem', letterSpacing: '0.45em',
            color: '#00ffea', textTransform: 'uppercase',
            padding: '4px 10px', border: '1px solid rgba(0,255,234,0.3)',
          }}>FIELD GUIDE</span>
          <span style={{ fontFamily: mono, fontSize: '0.55rem', letterSpacing: '0.3em', color: 'rgba(255,255,255,0.3)' }}>
            2026.05.18
          </span>
          <span style={{ fontFamily: mono, fontSize: '0.55rem', letterSpacing: '0.3em', color: 'rgba(255,255,255,0.3)' }}>
            Solana · DeFi · On-Chain Research
          </span>
        </div>
        ...
        <h1 style={{
          ...
          The SF Degen<br /><span style={{ color: '#00ffea' }}>Playbook</span>
        </h1>

        <p style={{
          fontSize: 'clamp(1rem, 2.5vw, 1.25rem)',
          lineHeight: 1.75, color: 'rgba(255,255,255,0.55)', letterSpacing: '0.03em',
          borderLeft: '2px solid rgba(0,255,234,0.4)', paddingLeft: 20, marginBottom: 0,
        }}>
          In SF, the best traders are the ones who write their own tools.
          Wallet tracking, MEV exposure mapping, liquidity skew detection —
          not alpha you buy, alpha you build.
        </p>
      </section>
