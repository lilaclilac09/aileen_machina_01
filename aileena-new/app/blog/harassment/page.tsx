...
export default function HarassmentArticle() {
  return (
    <SubstackShell
      category="Essay"
      date="2026.04.23"
      tags="Women in Tech · #MeToo · Crypto"
      title="Every Woman in Tech Has a #MeToo Story"
      dek={<>&ldquo;When nobody is listening, every woman in tech has a MeToo story.&rdquo; Not most. Every one.</>}
    >
      {/* ── Body ── */}
      <article style={{ maxWidth: 800, margin: '0 auto', padding: '64px 32px 120px' }}>
        ...
        <p style={bodyStyle}>
          The physical version functions the same way. I was at an event hosted by <strong style={{ color: '#fff' }}>Monad Foundation</strong> in Singapore, alone. A male acquaintance — someone I knew, not well — had been explicitly told by someone in the room to make clear he was not my partner. He was occupied elsewhere. Someone came up behind me suddenly and placed his hand on my shoulder and squeezed. Not a greeting. Deliberately threatening. Senior people nearby saw it. Nobody said anything. Nobody moved. So I stopped defending myself, and I kept moving.
        </p>
        <p style={bodyStyle}>
