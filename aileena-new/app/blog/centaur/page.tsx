    ...
    <div style={{
      ...
      <section style={{ padding: '80px 32px 64px', maxWidth: 900, margin: '0 auto' }}>
        ...
        <h1 style={{
          ...
          Centaur,<br /><span style={{ color: '#00ffea' }}>and the market it&apos;s landing in</span>
        </h1>
        ...
        <p style={{
          ...
          On May 21, 2026, Paradigm and Tempo open-sourced{' '}
          <a href="https://github.com/paradigmxyz/centaur" target="_blank" rel="noopener noreferrer" style={inlineLink}>Centaur</a>{' '}
          — a self-hosted runtime for &quot;multiplayer, secure agents.&quot; It isn&apos;t another coding agent. It&apos;s the
          backend that lets a whole team share one. This is a read on what they shipped, why they
          built it themselves, the product calls underneath each component, how they&apos;re telling
          the story, and where it lands in a suddenly crowded agent-infra market.
        </p>
      </section>
