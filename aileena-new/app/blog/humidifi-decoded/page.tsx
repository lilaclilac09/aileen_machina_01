    ...
    <div style={{
      ...
      <section style={{ padding: '80px 32px 64px', maxWidth: 900, margin: '0 auto' }}>
        ...
        <h1 style={{
          ...
          Humidifi,<br /><span style={{ color: '#00ffea' }}>Decoded</span>
        </h1>
        ...
        <p style={{
          ...
          Part II of <Link href="/blog/prop-amm-dict" style={inlineLink}>The Pool That Wasn&apos;t a Pool</Link>.
          Part I established that humidifi&apos;s 1728-byte accounts don&apos;t store mints — the offsets don&apos;t exist.
          Part II goes back in to map what <em>is</em> living in those bytes. Most of the account is dead. The
          live part is six narrow ranges, ~57 bytes total, including a u16 that looks like a price tick.
        </p>
      </section>
