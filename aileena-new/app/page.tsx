...
/* ── Homepage ─────────────────────────────────────────────────────────
 *
 * A studio opening (paper / vellum / embodied plate), then the clipping desk.
 * Information is intentionally minimal.
 *
 *   Section 01  Studio opening      — ink, vellum, reference plate, serials
 ...
 *
 * Visual language: cream / teal, coral as a stamp. DJ station stays black on /sound.
 */
  ...
  return (
    <>
      ...
      <SnapContainer key={language}>
        ...
        {/* ── 01 STUDIO OPENING — ink / vellum / embodied plate ─ */}
