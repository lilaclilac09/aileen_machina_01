...
- Site product patches: owner **proof queue** at `/evolution`. `/proof` is the KeyShield computer door. Agents propose; owner approves; no auto-merge. `pnpm verify:proof-queue`.
